...
oc set resources dc/tasks-blue -n ${GUID}-tasks-prod --limits=memory=2Gi,cpu=2 --requests=memory=1Gi,cpu=1
...
oc set resources dc/tasks-green -n ${GUID}-tasks-prod --limits=memory=2Gi,cpu=2 --requests=memory=1Gi,cpu=1
# Setting 'wrong' VERSION. This will need to be updated in the pipeline
